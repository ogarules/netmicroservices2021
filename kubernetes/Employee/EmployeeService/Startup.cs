...
namespace EmployeeService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EmployeeContext>(r => r.UseSqlServer(Configuration.GetConnectionString("DefaultConnectionString"), sqlServerOptionsAction: sqloptions =>
            {
            ...
            services.AddScoped<EmployeeService.Services.EmployeeService>();
